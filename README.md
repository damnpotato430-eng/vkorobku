...
<p align="center">
  <img src="assets/Screenshot 2026-07-15 020721.png" width="820" alt="Главное окно vKOROBKU" />
</p>
...
- автоматический поиск игр Steam и ручное добавление папок с определением игры;
...
- обложки Steam с резервом IGDB (ключи защищены DPAPI), журнал операций, окно настроек.
