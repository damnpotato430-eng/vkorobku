...
1. **Сортировка «Лучшие кандидаты»** — по потенциальной экономии.
2. **Подпись кода** — для доверия UAC-промпта воркера («проверенный издатель»); winget, вероятно, не нужен при Steam-дистрибуции.
